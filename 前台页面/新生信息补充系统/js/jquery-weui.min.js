...
function(t, e, n, i) {
	...
	t.MSPointerEvent && !t.PointerEvent && (Bt = "MSPointerDown", Gt = "MSPointerMove MSPointerUp MSPointerCancel"), c(F, _, {
		handler: function(t) {
			var e = this.store,
				n = !1,
...
function(t) {
	...
	t.toast = function(t, a, r) {
		...
		var o;
		"cancel" == a ? o = "weui_toast_cancel" : "forbidden" == a ? o = "weui_toast_forbidden" : "text" == a && (o = "weui_toast_text"), e('<i class="weui_icon_toast"></i><p class="weui_toast_content">' + (t || "已经完成") + "</p>", o), setTimeout(function() {
			n(r)
		}, i.duration)
	}, t.showLoading = function(t) {
		for (var n = '<div class="weui_loading">', i = 0; 12 > i; i++) n += '<div class="weui_loading_leaf weui_loading_leaf_' + i + '"></div>';
		n += "</div>", n += '<p class="weui_toast_content">' + (t || "数据加载中") + "</p>", e(n, "weui_loading_toast")
	...
	var e = function(e) {
			...
			var c = this,
				l = {
					...
					toolbarCloseText: "完成",
					title: "请选择",
					toolbarTemplate: '<div class="toolbar">          <div id="toolbar-inner" class="toolbar-inner">          <a href="javascript:;" class="picker-button close-picker">{{closeText}}</a>          <h1 class="title">{{title}}</h1>          </div>          </div>'
				};
			   var ll={
//					updateValuesOnMomentum: !1,
//					updateValuesOnTouchmove: !0,
...
//					toolbar: !0,
					toolbarCloseText: "取消",
					toolbarTemplate: '<div class="left">          <div class="left-inner">          <a href="javascript:;" class="picker-button close-picker">{{closeText}}</a>          <h1 class="title">{{title}}</h1>          </div>          </div>'
				};
			e = e || {};
			...
			return c.setValue = function(t, e) {
				...
				function r(e) {
					if (y) {
						...
						var n = t.getTouchPosition(e);
						x = n.y, T || (t.cancelAnimationFrame(w), T = !0, b = E = t.getTranslate(h.wrapper[0], "y"), h.wrapper.transition(0)), e.preventDefault();
						var i = x - k;
				...
				function o(e) {
					...
					y = T = !1, h.wrapper.transition(""), M && ("min" === M ? h.wrapper.transform("translate3d(0," + v + "px,0)") : h.wrapper.transform("translate3d(0," + g + "px,0)")), C = (new Date).getTime();
					var n, a;
					C - _ > 300 ? a = E : (n = Math.abs(O / (C - P)), a = E + O * c.params.momentumRatio), a = Math.max(Math.min(a, g), v);
...
function(t) {
	...
	var e, n = function(e, n) {
			this.config = n, this.data = {
				values: "",
				titles: "",
				origins: [],
				length: 0
			}, this.$input = t(e), this.$input.prop("readOnly", !0), this.initConfig(), n = this.config, this.$input.click(t.proxy(this.open, this))
		};
	n.prototype.initConfig = function() {
		...
		if (!this._open) {
			...
			this._bind(a), this._open = !0, i.onOpen && i.onOpen(this)
		}
		...
		return this.each(function() {
			...
			return "string" == typeof e && r[e].call(r, i), r
		})
...
function(t) {
	...
	var e, n = !1,
		i = function(i) {
			...
			function l() {
				u.opened = !1, u.input && u.input.length > 0 && u.input.parents(".page-content").css({
					"padding-bottom": ""
			...
			var h = u.isH && n ? -1 : 1;
			return u.animating = !1, u.addValue = function(t) {
				if (u.params.multiple) {
					u.value || (u.value = []);
					for (var e, n = 0; n < u.value.length; n++) new Date(t).getTime() === new Date(u.value[n]).getTime() && (e = n);
					"undefined" == typeof e ? u.value.push(t) : u.value.splice(e, 1), u.updateValue()
				} else u.value = [t], u.updateValue()
			}, u.setValue = function(t) {
				var e = new Date(t[0]);
				u.setYearMonth(e.getFullYear(), e.getMonth()), u.addValue(+e)
					...
					if (_) {
						...
						if (0 === n.length && t(e.target).hasClass("picker-calendar-day") && (n = t(e.target)), 0 !== n.length && !n.hasClass("picker-calendar-day-disabled")) {
							...
							var i = n.attr("data-year"),
								a = n.attr("data-month"),
								r = n.attr("data-day");
							u.params.onDayClick && u.params.onDayClick(u, n[0], i, a, r), u.addValue(new Date(i, a, r).getTime()), u.params.closeOnSelect && !u.params.multiple && u.close()
						}
					}
				}
				...
				u.updateCurrentMonthYear(t), u.months.removeClass("picker-calendar-month-current picker-calendar-month-prev picker-calendar-month-next");
				var e = "next" === t ? u.months.length - 1 : 0;
				u.months.eq(e).addClass("picker-calendar-month-current"), u.months.eq("next" === t ? e - 1 : e + 1).addClass("next" === t ? "picker-calendar-month-prev" : "picker-calendar-month-next"), u.params.onMonthYearChangeStart && u.params.onMonthYearChangeStart(u, u.currentYear, u.currentMonth)
				...
				t = t || u.monthsTranslate || 0, "undefined" == typeof u.monthsTranslate && (u.monthsTranslate = t), u.months.removeClass("picker-calendar-month-current picker-calendar-month-prev picker-calendar-month-next");
				var e = 100 * -(t + 1) * h,
					n = 100 * -t * h,
					i = 100 * -(t - 1) * h;
				u.months.eq(0).transform("translate3d(" + (u.isH ? e : 0) + "%, " + (u.isH ? 0 : e) + "%, 0)").addClass("picker-calendar-month-prev"), u.months.eq(1).transform("translate3d(" + (u.isH ? n : 0) + "%, " + (u.isH ? 0 : n) + "%, 0)").addClass("picker-calendar-month-current"), u.months.eq(2).transform("translate3d(" + (u.isH ? i : 0) + "%, " + (u.isH ? 0 : i) + "%, 0)").addClass("picker-calendar-month-next")
				...
				if (u.monthsTranslate--, n === u.currentMonth) {
					...
					u.wrapper.append(c[0]), u.months = u.wrapper.find(".picker-calendar-month"), u.params.onMonthAdd && u.params.onMonthAdd(u, u.months.eq(u.months.length - 1)[0])
				}
				u.animating = !0, u.onMonthChangeStart("next");
				var l = 100 * u.monthsTranslate * h;
				u.wrapper.transition(e).transform("translate3d(" + (u.isH ? l : 0) + "%, " + (u.isH ? 0 : l) + "%, 0)"), o && u.wrapper.transitionEnd(function() {
				...
				if (u.monthsTranslate++, n === u.currentMonth) {
					...
					u.wrapper.prepend(c[0]), u.months = u.wrapper.find(".picker-calendar-month"), u.params.onMonthAdd && u.params.onMonthAdd(u, u.months.eq(0)[0])
				}
				...
				"undefined" == typeof t && (t = u.currentYear), "undefined" == typeof e && (e = u.currentMonth), "undefined" != typeof n && "object" != typeof n || (n = "", u.params.animate || (n = 0));
				var i;
				...
				n = "weui-picker-calendar " + (u.params.cssClass || ""), u.inline || (n = "weui-picker-modal " + n);
				...
				var e = a() && !1,
					n = !1;
				u.opened || (u.value || u.params.value && (u.value = u.params.value, n = !0), u.layout(), e ? (u.pickerHTML = '<div class="popover popover-picker-calendar"><div class="popover-inner">' + u.pickerHTML + "</div></div>", u.popover = t.popover(u.pickerHTML, u.params.input, !0), u.container = t(u.popover).find(".weui-picker-modal"), t(u.popover).on("close", function() {
					l()
...
function(t) {
	...
	t.openPopup = function(e, n) {
		t.closePopup(), e = t(e), e.show(), e.width(), e.addClass("weui-popup-container-visible");
...
function(t) {
	...
	t.notification = t.noti = function(a) {
		a = t.extend({}, n, a), e = t(".notification"), e[0] || (e = t('<div class="notification"></div>').appendTo(document.body), u(e)), e.off("noti-click"), a.onClick && e.on("noti-click", function() {
			a.onClick(a.data)
		}), e.html(t.t7.compile(a.tpl)(a)), e.show(), e.addClass("notification-in"), e.data("params", a);
		var r = function() {
...
function(t) {
	...
	t.toptip = function(n, i, a) {
		if (n) {
			...
			o = t('<div class="weui_toptips"></div>').appendTo(document.body), o.html(n), o[0].className = "weui_toptips " + r, clearTimeout(e), o.hasClass("weui_toptips_visible") || (o.show().width(), o.addClass("weui_toptips_visible")), e = setTimeout(function() {
